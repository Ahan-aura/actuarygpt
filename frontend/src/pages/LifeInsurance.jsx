                ...
                <button 
                  ...
                  onClick={() => {
                    if (!formData.product_info_2 || !formData.fullName || !formData.phone || !formData.email || !formData.coverage_amount || 
                        !formData.age || !formData.income || !formData.height || !formData.weight || !formData.occupation) {
                      alert("Please complete all required fields (*), including demographics and lifestyle details.");
                      return;
                    }
                    setWizardStep(2);
                  }}
