...
base_url = 'https://actuarygpt-backend.onrender.com'
...
print("Submitting new application to remote backend...")
...
app_id = app_data['id']
print(f"Evaluating application {app_id} on remote backend...")
